...
function fiszkaAnswer(word) {
	...
	if (settings.reverseWords == 'off') {
		...
		return `
			...
			<div class="nauka-slowka">
				<h1 class="">`+ word.fo + ` <i class="fas fa-volume-down ml-1 textToSpeech" data-text="` + word.fo + `" data-lang="` + word.lang + `"></i></h1>
				<span style="font-size: 1.2em; font-weight: 300;" class="mt-3">`+ word.pl + `</span>
			</div>
		...
		return `
			...
			<div class="nauka-slowka">
				<h1 class="">`+ word.pl + ` <i class="fas fa-volume-down ml-1 textToSpeech" data-text="` + word.pl + `" data-lang="pl"></i></h1>
				<span style="font-size: 1.2em; font-weight: 300;" class="mt-3">`+ word.fo + `</span>
			</div>
